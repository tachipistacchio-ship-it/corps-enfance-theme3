            ...
            <div className="text-center py-8">
              <div className="mb-6">
                <p className="text-lg text-gray-700 mb-4">
                  Approfondissez vos connaissances avec des exercices pratiques et analytiques.
                </p>
                <div className="bg-yellow-50 p-4 rounded-lg mb-6">
                  <h3 className="font-semibold text-yellow-900 mb-2">Ce que vous allez travailler :</h3>
                  <ul className="text-yellow-800 text-sm space-y-1">
                    <li>• Analyse chronologique des évolutions</li>
                    <li>• Étude comparative des approches</li>
                    <li>• Réflexion critique sur les enjeux sociaux</li>
                    <li>• Synthèse des transformations historiques</li>
                    <li>• Application des concepts théoriques</li>
                  </ul>
                </div>
              </div>
              <button
                onClick={() => setExercisesStarted(true)}
                className="bg-yellow-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-yellow-700 transition-colors shadow-lg"
              >
